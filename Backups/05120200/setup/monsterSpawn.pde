void monsterSpawn(){ // inputs are monster speed, monster size, monster xPos, monster yPos, monster attack range, hp
  ...
  goblin[3] = new Monster(1,32,room2.xPos + 100, room2.yPos + 130, 10,100);
  goblin[4] = new Monster(1,32,room2.xPos + 100, room2.yPos + 230, 10,100);
